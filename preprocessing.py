...
def preprocessing():
    ...
    with open('/Users/loubnabaroudi/Documents/UMICH/ME599/HW4_perception_solution/labels3.csv') as f:
        reader = csv.DictReader(f) # read rows into a dictionary format
        for row in reader: # read a row as {column1: value1, column2: value2,...}
            for (k,v) in row.items(): # go over each column name and value 
                columns[k].append(v)
                
    path_train = '/Users/loubnabaroudi/Documents/UMICH/ME599/HW4_perception_solution/deploy/trainval/*/*.jpg'   
    files_train =glob.glob(path_train)

    path_test = '/Users/loubnabaroudi/Documents/UMICH/ME599/HW4_perception_solution/deploy/test/*/*.jpg'   
